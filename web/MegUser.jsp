...
<%--                            </div>--%>
            ...
            <p>
            <form name="form1" method="post" action="MegUser.jsp">
                <div class="text-center">
                    第<%=p %>页 共<%=intpagecount %>页&nbsp;&nbsp;
                    <%
                        if(p>1) {
                    %>
                    <a href="MegUser.jsp?page=1" class="btn btn-secondary">第一页</a>
                    <a href="MegUser.jsp?page=<%=p-1 %>" class="btn btn-secondary">上一页</a>&nbsp;&nbsp;
                    <%
                        }
                        if(p<intpagecount) {
                    %>
                    <a href="MegUser.jsp?page=<%=p+1 %>" class="btn btn-secondary">下一页</a>
                    <a href="MegUser.jsp?page=<%=intpagecount %>" class="btn btn-secondary">最后一页</a>&nbsp;&nbsp;
                    <%
                        }
                    %>
            ...
            <form action="${pageContext.request.contextPath}/MegsCollection?method=update" method="post">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="content" id="notice_content" rows="3" placeholder="请输入内容"></textarea>
                    </div>
                    <div class="mb-3">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="mb-3">
                        <label for="norder-num" class="form-label">订单号</label>
