                    ...
                    <table class="table table-hover table-bordered" width="750" border="0" align="center" cellpadding="0" cellspacing="1"
                        ...
                        <tr bgcolor="#ffffff" height="25" align="center" valign="middle" class="STYLE1">
                            ...
                            <td width="528" align="left">&nbsp;&nbsp;
                                <jsp:useBean id="us" class="mybean.users" scope="request"/>
                                <jsp:getProperty name="us" property="backNews"/>
                            </td>
                        </tr>
                        <tr bgcolor="#ffffff" height="25" align="center" valign="middle" class="STYLE1">
                            <td>结果二：</td>
                            <td align="left">&nbsp;&nbsp;
                                <jsp:useBean id="eu" class="mybean.emuser" scope="request"/>
                                <jsp:getProperty name="eu" property="backNews"/>
                            </td>
                        </tr>
                        <tr bgcolor="#ffffff" height="25" align="center" valign="middle" class="STYLE1">
                            <td>结果三：</td>
