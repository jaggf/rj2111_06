...
<div class="container">
    ...
    <div class="row">
        <div class="col">
            <%
                try{
                    String strSql="SELECT eid, passwd FROM emuser;";
                    ResultSet rss=bd.getRs(strSql);
            %>
            <form action="${pageContext.request.contextPath}/acount?method=usermoreDelete" method="post">
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal">
                    新增
            ...
            <p>
            <form name="form1" method="post" action="user_ac.jsp">
                <div class="text-center">
                    第<%=p %>页 共<%=intpagecount %>页&nbsp;&nbsp;
                    <%
                        if(p>1) {
                    %>
                    <a href="user_ac.jsp?page=1" class="btn btn-secondary">第一页</a>
                    <a href="user_ac.jsp?page=<%=p-1 %>" class="btn btn-secondary">上一页</a>&nbsp;&nbsp;
                    <%
                        }
                        if(p<intpagecount) {
                    %>
                    <a href="user_ac.jsp?page=<%=p+1 %>" class="btn btn-secondary">下一页</a>
                    <a href="user_ac.jsp?page=<%=intpagecount %>" class="btn btn-secondary">最后一页</a>&nbsp;&nbsp;
                    <%
                        }
                    %>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-container">
                    <form action="${pageContext.request.contextPath}/acount?method=usersave" method="post">
                        <%--                        <div class="mb-3">--%>
...
<div class="modal fade" id="updateNoticeModal" tabindex="-1" aria-labelledby="updateNoticeModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="${pageContext.request.contextPath}/acount?method=userupdate" method="post">
                <div class="modal-body">
