...
<div class="">
    <table width="1024" height="30" border="0" align="center" cellpadding="0" cellspacing="0" background="">
        <tr>
            ...
            <td align="right">
                <a href="${pageContext.request.contextPath}/renshi/kq/managekaoqin.jsp"><span class="STYLE1 badge bg-warning text-light">&nbsp;Web人事管理平台</span></a>
...
<div class="">
    <table class="table table-hover"  align="center" width="1000" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="850">
                <%
                    try{
                        String strSql="SELECT eid,ename,uptime,downtime,date,incu FROM kaoqin WHERE incu='在职'";
                        ResultSet rs=bd.getRs(strSql);
                %>
                <center><h2>管理员工考勤信息</h2></center>
                <table style="text-align: center" class="table table-hover" border="1" align="center" border="0" cellpadding="2"
                       cellspacing="1">
                    ...
                    <tr height="30" bgcolor="#ffffff" align="center">
                        ...
                        <td>
                            <a class="badge badge-success" href="${pageContext.request.contextPath}/rs_modkq?id=<%=rs.getString(1) %>">修改</a>
                ...
                <form name="form1" method="post" action="managekaoqin.jsp">
                    <center>
                        ...
                        <%
                            if(p>1) {
                        %>
                        <a href="managekaoqin.jsp?page=1">第一页</a>
                        <a href="managekaoqin.jsp?page=<%=p-1 %>">上一页</a>&nbsp;&nbsp;
                        <%
                            }
                            if(p<intpagecount) {
                        %>
                        <a href="managekaoqin.jsp?page=<%=p+1 %>">下一页</a>
                        <a href="managekaoqin.jsp?page=<%=intpagecount %>">最后一页
                        </a>&nbsp;&nbsp;
                        <%
                            }
                        %>
