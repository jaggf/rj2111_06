...
<style type="text/css">
    body{
        ...
        height: 100%;
        background-image: linear-gradient(rgba(255, 225, 225, 0.85), #faf7f7);
    }
</style>
<body>
<div class="">
...
<div id="mySidenav" class="sidenav">
    ...
    <a class="badge badge-light" href="${pageContext.request.contextPath}/renshi/jxkh/managejx.jsp">管理绩效信息</a>
...
<div class="">
    <table class="table table-hover" width="1000" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="850">
                <%
                    try{
                        String strSql="SELECT eid,ename,wk,mon,date,zt FROM jx WHERE zt='正常'";
                ...
                <table class="table table-hover" border="1" align="center" border="0" cellpadding="2"
                    ...
                    <tr height="30" bgcolor="#ffffff" align="center">
                        ...
                        <td class="badge badge-success"><%=rs.getString(6) %></td>
                        <td>
                            <a class="badge badge-warning" href="${pageContext.request.contextPath}/rs_modjx?id=<%=rs.getString(1) %>">修改</a>
<%--                            <a class="badge badge-danger" href="${pageContext.request.contextPath}/?id=<%=rs.getString(1) %>">删除</a>--%>
                        </td>
                    </tr>
                    <%
                            }
                ...
                <form name="form1" method="post" action="managejx.jsp">
                    <center>
                        ...
                        <%
                            if(p>1) {
                        %>
                        <a href="managejx.jsp?page=1">第一页</a>
                        <a href="managejx.jsp?page=<%=p-1 %>">上一页</a>&nbsp;&nbsp;
                        <%
                            }
                            if(p<intpagecount) {
                        %>
                        <a href="managejx.jsp?page=<%=p+1 %>">下一页</a>
                        <a href="managejx.jsp?page=<%=intpagecount %>">最后一页
                        </a>&nbsp;&nbsp;
                        <%
                            }
                        %>
