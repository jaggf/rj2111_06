...
@WebServlet(name = "rs_modxq", value = "/rs_modxq")
public class rs_modxq extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if( rs.next()){
                ...
                xq.setBackNews("无此员工档案信息，单击<a href='renshi/zpxq/managexq.jsp'> <font color='red'>返回</font></a>，重新选择");
            }
            bd.closeConn();
        }
        ...
        RequestDispatcher dispatcher=request.getRequestDispatcher("renshi/zpxq/modxq.jsp");
