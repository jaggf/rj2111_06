...
@WebServlet(name = "modms", value = "/modms")
public class modms extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if( rs.next()){
                ...
                ms.setBackNews("无此员工档案信息，单击<a href='ms/manage.jsp'> <font color='red'>返回</font></a>，重新选择");
            }
            bd.closeConn();
        }
        ...
        RequestDispatcher dispatcher=request.getRequestDispatcher("ms/modms.jsp");
