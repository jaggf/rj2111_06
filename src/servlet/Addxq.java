...
import mybean.xq;
@WebServlet(name = "Addxq", value = "/Addxq")
public class Addxq extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            try {
                ...
                if (rs.next()) {
                    xq.setBackNews(" 该员工编号已存在，单击 <a href='xq/addxq.jsp'><font color='green'>返回</font></a>，重新添加");
                } else {
                    ...
                    if (n > 0) {
                        xq.setBackNews(" 添 加 <font color='red'> 成 功 </font> ，单击 <a href='xq/addxq.jsp'><font color='red'>返回</font></a>，继续添加");
                    } else {
                        xq.setBackNews(" 添 加 <font color='red'> 失 败 </font> ，单击 <a href='xq/addxq.jsp'><font color='red'>返回</font></a>，重新添加");
                    }
                }
                bd.closeConn();
