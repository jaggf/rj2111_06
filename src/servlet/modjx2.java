...
@WebServlet(name = "modjx2", value = "/modjx2")
public class modjx2 extends HttpServlet {
    @Override
...
doPost(request,response);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if(n>0) {
                jx.setBackNews("修改成功，单击<a href='jx/managejx.jsp'><font color='red'>返回</font></a>管理员工档案，继续修改");
            }
            else {
                jx.setBackNews("修改失败，单击<a href='modjx?id="+eid+"'> <font color='red'>返回</font></a>，重新修改");
            }
            bd.closeConn();
        }
