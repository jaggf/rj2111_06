...
@WebServlet("/JxCollection")
public class JxCollection extends HttpServlet {
	@Serial
		...
		switch (method) {
			...
			case "moreDelete":
				try {
					...
					Boolean boo = false;
					for (String ides : ids) {
						String sqls = "DELETE FROM jx WHERE  eid= " + ides;
				...
				RequestDispatcher dispatchersss = request.getRequestDispatcher("jx/managejx.jsp");
