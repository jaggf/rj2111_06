...
@WebServlet(name = "modjx", value = "/modjx")
public class modjx extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if( rs.next()){
                ...
                jx.setBackNews("无此员工档案信息，单击<a href='jx/managejx.jsp'> <font color='red'>返回</font></a>，重新选择");
            }
            bd.closeConn();
        }
        ...
        RequestDispatcher dispatcher=request.getRequestDispatcher("jx/modjx.jsp");
