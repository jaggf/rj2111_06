...
@WebServlet(name = "Addkaoqin", value = "/Addkaoqin")
public class Addkaoqin extends HttpServlet {
    @Override
...
doPost(request,response);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if( rs.next()){
                kq.setBackNews(" 该员工编号已存在，单击 <a href='kaoqin/addkaoqin.jsp'><font color='green'>返回</font></a>，重新添加");
            }
                ...
                if(n>0) {
                    kq.setBackNews(" 添 加 <font color='red'> 成 功 </font> ，单击 <a href='kaoqin/addkaoqin.jsp'><font color='red'>返回</font></a>，继续添加");
                }
                else {
                    kq.setBackNews(" 添 加 <font color='red'> 失 败 </font> ，单击 <a href='kaoqin/addkaoqin.jsp'><font color='red'>返回</font></a>，重新添加");
                }
            }
            bd.closeConn();
        }
